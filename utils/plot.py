...
data_1 = torch.load('/root/autodl-tmp/code/2.basic_unet_3/logs/plot_loss_0.92.pth')
data_2 = torch.load('/root/autodl-tmp/code/2.basic_unet_3/logs/plot_dice_0.92.pth')
# 生成 x 和 y1、y2 数据
